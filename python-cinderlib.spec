...
%check
# Tests fail using tox in build environment because cinderlib has specific logic which for execution as venv
# which is not functional on the rpm'd version. We use stestr instead and skip two tests specific to venv
# execution of cinderlib in a venv.
export PYTHONPATH=%{buildroot}%{python3_sitelib}
stestr run --exclude-regex "(.*set_priv_helper_venv.*)"
...
%changelog
# REMOVEME: error caused by commit https://opendev.org/openstack/cinderlib/commit/fb6178197fe75369026a21fbce92a384eaf97944
